...
---
### DoD / Acceptance Criteria (Phase 3)
- RBAC + CSRF maintained for new endpoints
- Happy-path persistence for users/roles/feature-flags
- 422/404 covered with RFC7807
- Audit events verified for all mutations
- OpenAPI validated in CI
- Admin suite green

### When ready for review
- CI green
- Branch rebased on default
