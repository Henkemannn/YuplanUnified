...
from pathable.accessors import BaseAccessor, LookupAccessor
from pathable.dataclasses import BasePathData
from pathable.parsers import SEPARATOR, parse_args
...
class BasePath(BasePathData):
    ...
    def __init__(self, *args: Any, **kwargs: Any):
        ...
        self._cparts_cached: list[str] | None = None
...
class AccessorPath(BasePath):
    ...
    def __init__(self, accessor: BaseAccessor, *args: Any, **kwargs: Any):
        ...
        self._content_cached: Any | None = None
