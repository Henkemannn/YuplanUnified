...
from ._greenlet import (
    _C_API,  # pylint:disable=no-name-in-module
    GreenletExit,
    error,
    getcurrent,
    greenlet,
...
from ._greenlet import (
    CLOCKS_PER_SEC,  # pylint:disable=unused-import
    GREENLET_USE_CONTEXT_VARS,  # pylint:disable=unused-import
    GREENLET_USE_GC,  # pylint:disable=unused-import
    GREENLET_USE_TRACING,  # pylint:disable=unused-import
    enable_optional_cleanup,  # pylint:disable=unused-import
