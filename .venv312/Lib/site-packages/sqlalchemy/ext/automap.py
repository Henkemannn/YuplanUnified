...
class GenerateRelationshipType(Protocol):
    ...
    def __call__(
        ...
        base: type[Any],
        direction: RelationshipDirection,
        return_fn: Callable[..., Relationship[Any]] | Callable[..., ORMBackrefArgument],
        attrname: str,
        local_cls: type[Any],
        referred_cls: type[Any],
        **kw: Any,
...
class AutomapBase:
    ...
    def prepare(
        ...
        name_for_scalar_relationship: NameForScalarRelationshipType | None = None,
        name_for_collection_relationship: NameForCollectionRelationshipType | None = None,
        generate_relationship: GenerateRelationshipType | None = None,
        reflection_options: dict[_KT, _VT] | immutabledict[_KT, _VT] = util.EMPTY_DICT,
    ) -> None:
        ...
        with _CONFIGURE_MUTEX:
            table_to_map_config: dict[Table | None, _DeferredMapperConfig] | dict[Table, _DeferredMapperConfig] = {
...
def _relationships_for_fks(
    ...
    local_table = cast("Table | None", map_config.local_table)
    local_cls = cast(
        "type[Any] | None", map_config.cls
