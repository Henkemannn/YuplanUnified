...
class ShardedSession(Session):
    ...
    def __init__(
        ...
        execute_chooser: Callable[[ORMExecuteState], Iterable[Any]] | None = None,
        shards: dict[str, Any] | None = None,
        query_cls: type[Query[_T]] = ShardedQuery,
        *,
        id_chooser: Callable[[Query[_T], Iterable[_T]], Iterable[Any]] | None = None,
...
def execute_and_instances(
    orm_context: ORMExecuteState,
) -> Result[_T] | IteratorResult[_TP]:
    active_options: None | QueryContext.default_load_options | type[QueryContext.default_load_options] | BulkUDCompileState.default_update_options | type[BulkUDCompileState.default_update_options]
