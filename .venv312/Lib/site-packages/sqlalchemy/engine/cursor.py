...
from ..sql import elements, sqltypes, util as sql_util
from ..sql.base import _generative
from ..sql.compiler import RM_NAME, RM_OBJECTS, RM_RENDERED_NAME, RM_TYPE, ResultColumnsEntry
...
if typing.TYPE_CHECKING:
    ...
    from .interfaces import DBAPICursor, Dialect, ExecutionContext, _DBAPICursorDescription
    from .result import (
        _KeyIndexType,
        _KeyMapRecType,
        _KeyMapType,
    ...
    def splice_horizontally(self, other):
        ...
        total_rows = [
            ...
            for r1, r2 in zip(
                ...
                list(other._raw_row_iterator()), strict=False,
            )
        ]
