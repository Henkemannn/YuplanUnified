...
if TYPE_CHECKING:
    ...
    from ..sql.schema import Column, DefaultGenerator, SchemaItem, Sequence as Sequence_SchemaItem
...
class Dialect(EventTarget):
    ...
    construct_arguments: list[tuple[type[SchemaItem | ClauseElement], Mapping[str, Any]]] | None = None
