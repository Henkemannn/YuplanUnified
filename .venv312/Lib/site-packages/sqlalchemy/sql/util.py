...
from .annotation import (
    _deep_annotate as _deep_annotate,  # noqa: F401
    _deep_deannotate as _deep_deannotate,  # noqa: F401
    _shallow_annotate as _shallow_annotate,  # noqa: F401
)
...
from .elements import (
    ...
    Null,
    UnaryExpression,
    _find_columns as _find_columns,
    _label_reference,
    _textual_label_reference,
)
from .schema import Column
from .selectable import Alias, FromClause, FromGrouping, Join, ScalarSelect, SelectBase, TableClause
...
if typing.TYPE_CHECKING:
    ...
    from .visitors import ExternallyTraversible, ExternalTraversal, _TraverseCallableType
...
class ClauseAdapter(visitors.ReplacingExternalTraversal):
    ...
    def replace(
        ...
        if self.include_fn and not self.include_fn(col) or self.exclude_fn and self.exclude_fn(col):  # type: ignore
            return None
