...
if typing.TYPE_CHECKING:
    ...
    from ..engine.interfaces import CacheStats, CompiledCacheType, Dialect, SchemaTranslateMapType
...
class CreateTable(_CreateBase):
    ...
    def __init__(
        self,
        element: Table,
        include_foreign_key_constraints: typing_Sequence[ForeignKeyConstraint] | None = None,
...
def sort_tables(
    ...
    extra_dependencies: typing_Sequence[tuple[TableClause, TableClause]] | None = None,
) -> list[Table]:
