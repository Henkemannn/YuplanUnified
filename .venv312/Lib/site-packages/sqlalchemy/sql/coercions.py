...
@overload
def expect(
    role: type[roles.ExpressionElementRole[Any]] | type[roles.LimitOffsetRole] | type[roles.WhereHavingRole],
    element: _ColumnExpressionArgument[_T],
    **kw: Any,
) -> ColumnElement[_T]: ...
...
@overload
def expect(
    role: type[roles.ExpressionElementRole[Any]] | type[roles.LimitOffsetRole] | type[roles.WhereHavingRole] | type[roles.OnClauseRole] | type[roles.ColumnArgumentRole],
    element: Any,
    **kw: Any,
) -> ColumnElement[Any]: ...
