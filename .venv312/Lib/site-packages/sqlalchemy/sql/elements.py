...
def literal_column(
    text: str, type_: _TypeEngineArgument[_T] | None = None
) -> ColumnClause[_T]:
...
class ClauseElement(
    ...
    @property
    def _order_by_label_element(self) -> Label[Any] | None:
        return None
    ...
    def unique_params(
        self,
        __optionaldict: dict[str, Any] | None = None,
        **kwargs: Any,
    ) -> Self:
    ...
    def params(
        self,
        __optionaldict: Mapping[str, Any] | None = None,
        **kwargs: Any,
    ) -> Self:
        """Return a copy with :func:`_expression.bindparam` elements
        replaced.
    ...
    def _replace_params(
        self,
        unique: bool,
        optionaldict: Mapping[str, Any] | None,
        kwargs: dict[str, Any],
    ) -> Self:
        if optionaldict:
...
class SQLCoreOperations(Generic[_T_co], ColumnOperators, TypingOnly):
    ...
    if typing.TYPE_CHECKING:
        ...
        def op(
            ...
            precedence: int = ...,
            is_comparison: bool = ...,
            return_type: _TypeEngineArgument[Any] | None = ...,
            python_impl: Callable[..., Any] | None = ...,
        ...
        def op(
            ...
            return_type: _TypeEngineArgument[Any] | None = None,
            python_impl: Callable[..., Any] | None = None,
        ) -> Callable[[Any], BinaryExpression[Any]]: ...
        ...
        def in_(
            self,
            other: Iterable[Any] | BindParameter[Any] | roles.InElementRole,
        ) -> BinaryExpression[bool]: ...
...
class ColumnElement(
    ...
    _is_clone_of: ColumnElement[_T] | None
    ...
    @HasMemoized.memoized_attribute
    def _tq_key_label(self) -> str | None:
    ...
    @property
    def _non_anon_label(self) -> str | None:
    ...
    @HasMemoized.memoized_attribute
    def _expression_label(self) -> str | None:
    ...
    def _make_proxy(
        ...
        *,
        ...
        compound_select_cols: Sequence[ColumnElement[Any]] | None = None,
        **kw: Any,
    ...
    def _anon_label(
        self, seed: str | None, add_hash: int | None = None
    ) -> _anonymous_label:
        while self._is_clone_of is not None:
            self = self._is_clone_of
...
class BindParameter(roles.InElementRole, KeyedColumnElement[_T]):
    ...
    def __init__(
        ...
        literal_execute: bool = False,
        _compared_to_operator: OperatorType | None = None,
        _compared_to_type: TypeEngine[Any] | None = None,
        _is_crud: bool = False,
    ):
        ...
        if type_ is None:
            ...
            if value:
                if expanding:
                    ...
                    check_value = value
                cast("BindParameter[tuple[Any, ...]]", self).type = (
...
class True_(SingletonConstant, roles.ConstExprRole[bool], ColumnElement[bool]):
    ...
    @classmethod
    def _ifnone(
        cls, other: ColumnElement[Any] | None
    ) -> ColumnElement[Any]:
        if other is None:
...
class ClauseList(
    ...
    def _construct_raw(
        ...
        clauses: Sequence[ColumnElement[Any]] | None = None,
    ) -> ClauseList:
...
class ExpressionClauseList(OperatorExpression[_T]):
    ...
    clauses: tuple[ColumnElement[Any], ...]
...
class BooleanClauseList(ExpressionClauseList[bool]):
    ...
    ) -> tuple[int, list[ColumnElement[Any]]]:
    ...
    def and_(
        cls,
        initial_clause: Literal[True] | _ColumnExpressionArgument[bool] | _NoArg = _NoArg.NO_ARG,
    ...
    def or_(
        cls,
        initial_clause: Literal[False] | _ColumnExpressionArgument[bool] | _NoArg = _NoArg.NO_ARG,
        *clauses: _ColumnExpressionArgument[bool],
    ) -> ColumnElement[bool]:
...
class Tuple(ClauseList, ColumnElement[tuple[Any, ...]]):
        ...
        *clauses: _ColumnExpressionArgument[Any],
        ...
        if types is None:
            ...
            init_clauses = [
                ...
                for typ, c in zip(types, clauses, strict=False)
            ]
        ...
        if expanding:
            ...
            return Tuple(
                *[
                    ...
                    for o, compared_to_type in zip(obj, self.type.types, strict=False)
                ]
            )
...
class Case(ColumnElement[_T]):
    ...
    whens: list[tuple[ColumnElement[bool], ColumnElement[_T]]]
    else_: ColumnElement[_T] | None
    value: ColumnElement[Any] | None

    def __init__(
        self,
        *whens: tuple[_ColumnExpressionArgument[bool], Any] | Mapping[Any, Any],
        value: Any | None = None,
        else_: Any | None = None,
    ):
...
class UnaryExpression(ColumnElement[_T]):
    ...
    def __init__(
        ...
        modifier: OperatorType | None = None,
        type_: _TypeEngineArgument[_T] | None = None,
...
class Grouping(GroupedElement, ColumnElement[_T]):
    ...
    def __init__(
        self, element: TextClause | ClauseList | ColumnElement[_T]
    ):
        self.element = element
...
class _OverrideBinds(Grouping[_T]):
    ...
    def __init__(
        ...
        self.element = element
        self.translate = {
            k.key: v.value for k, v in zip(replaces_params, bindparams, strict=False)
        }
...
class Over(ColumnElement[_T]):
    ...
    range_: tuple[_IntOrRange, _IntOrRange] | None
    rows: tuple[_IntOrRange, _IntOrRange] | None
...
class WithinGroup(ColumnElement[_T]):
    ...
    def __init__(
        self,
        element: FunctionElement[_T] | FunctionFilter[_T],
...
class FunctionFilter(Generative, ColumnElement[_T]):
    ...
    def __init__(
        self,
        func: FunctionElement[_T] | WithinGroup[_T],
        *criterion: _ColumnExpressionArgument[bool],
    ):
        self.func = func
    ...
    def over(
        self,
        partition_by: Iterable[_ColumnExpressionArgument[Any]] | _ColumnExpressionArgument[Any] | None = None,
        order_by: Iterable[_ColumnExpressionArgument[Any]] | _ColumnExpressionArgument[Any] | None = None,
        range_: tuple[int | None, int | None] | None = None,
        rows: tuple[int | None, int | None] | None = None,
    ) -> Over[_T]:
...
class Label(roles.LabeledColumnExprRole[_T], NamedColumn[_T]):
    ...
    def self_group(self, against: OperatorType | None = None) -> Label[_T]:
...
class ColumnClause(
    ...
    onupdate: DefaultGenerator | None = None
    default: DefaultGenerator | None = None
    server_default: FetchedValue | None = None
...
class quoted_name(util.MemoizedSlots, str):
    ...
    @classmethod
    def construct(
        cls, value: str | None, quote: bool | None
    ) -> quoted_name | None:
        if value is None:
            return None
        else:
