...
def _deep_annotate(
    ...
    *,
    ...
    annotate_callable: Callable[[SupportsAnnotations, _AnnotationDict], SupportsAnnotations] | None = None,
) -> _SA:
...
def _new_annotation_type(
    ...
    if "_traverse_internals" in cls.__dict__ or cls.__dict__.get("inherit_cache", False):
