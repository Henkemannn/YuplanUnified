...
from .elements import ClauseElement, ColumnClause, ColumnElement, TextClause, quoted_name
...
_ConstraintNameArgument = Optional[str | _NoneName]
...
class Table(
    ...
    def __init__(
        ...
        *args: SchemaItem,
        ...
        listeners: _typing_Sequence[tuple[str, Callable[..., Any]]] | None = None,
    ...
    def tometadata(
        ...
        referred_schema_fn: Callable[[Table, str | None, ForeignKeyConstraint, str | None], str | None] | None = None,
        name: str | None = None,
    ) -> Table:
...
class Column(DialectKWArgs, SchemaItem, ColumnClause[_T]):
    ...
    def __init__(
        self,
        __name_pos: str | _TypeEngineArgument[_T] | SchemaEventTarget | None = None,
        __type_pos: _TypeEngineArgument[_T] | SchemaEventTarget | None = None,
    ...
    def _make_proxy(
        ...
        compound_select_cols: _typing_Sequence[ColumnElement[Any]] | None = None,
        **kw: Any,
...
class ForeignKey(DialectKWArgs, SchemaItem):
    ...
    def _get_colspec(
        self,
        schema: str | Literal[SchemaConst.RETAIN_SCHEMA, SchemaConst.BLANK_SCHEMA] | None = None,
...
class ColumnCollectionMixin:
    ...
    def __init__(
        ...
        *columns: _DDLColumnArgument,
        ...
        _gather_expressions: list[str | ColumnElement[Any]] | None = None,
    ) -> None:
        self._column_flag = _column_flag
        self._columns = DedupeColumnCollection()

        processed_expressions: list[ColumnElement[Any] | str] | None = _gather_expressions
...
class ForeignKeyConstraint(ColumnCollectionConstraint):
    ...
    def _elements(self) -> util.OrderedDict[str, ForeignKey]:
        ...
        return util.OrderedDict(zip(self.column_keys, self.elements, strict=False))
    ...
    def _set_parent(self, parent: SchemaEventTarget, **kw: Any) -> None:
        ...
        for col, fk in zip(self._columns, self.elements, strict=False):
    ...
    def _copy(
        ...
        **kw: Any,
        ...
        for self_fk, other_fk in zip(self.elements, fkc.elements, strict=False):
    ...
    def _autoincrement_column(self) -> Column[int] | None:
        def _validate_autoinc(col: Column[Any], autoinc_true: bool) -> bool:
            if col.type._type_affinity is None or not issubclass(
                ...
                and not autoinc_true
            ) or col.foreign_keys and col.autoincrement not in (
                True,
                "ignore_fk",
            ):
                return False
...
class Index(
    ...
    def _set_parent(self, parent: SchemaEventTarget, **kw: Any) -> None:
        ...
        exprs = []
        for expr, colexpr in zip(expressions, col_expressions, strict=False):
...
class MetaData(HasSchemaAttr):
    ...
    def reflect(
        ...
        schema: str | None = ...,
        views: bool = ...,
        only: _typing_Sequence[str] | Callable[[str, MetaData], bool] | None = ...,
    ...
    def reflect(
        ...
        schema: str | None = None,
        views: bool = False,
        only: _typing_Sequence[str] | Callable[[str, MetaData], bool] | None = None,
        extend_existing: bool = False,
        autoload_replace: bool = True,
        resolve_fks: bool = True,
        **dialect_kwargs: Any,
        ...
        with inspection.inspect(bind)._inspection_context() as insp:
            ...
            if only is None:
                load = [
                    name
                    for name, schname in zip(available, available_w_schema, strict=False)
