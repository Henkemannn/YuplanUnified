...
if typing.TYPE_CHECKING or not HAS_CYEXTENSION:
    from ._py_util import cache_anon_map as anon_map, prefix_anon_map as prefix_anon_map
else:
    from sqlalchemy.cyextension.util import (  # noqa: F401,E501  # noqa: F401,E501
    ...
    def clone(elem: ExternallyTraversible, **kw: Any) -> ExternallyTraversible:
        if elem in stop_on:
            ...
            if id(elem) not in cloned:
                if "replace" in kw:
                    newelem = cast(
                        ExternallyTraversible | None, kw["replace"](elem)
                    )
