...
if typing.TYPE_CHECKING:
    ...
    from .sqltypes import (
        BOOLEANTYPE as BOOLEANTYPE,  # noqa: F401
        INDEXABLE as INDEXABLE,  # noqa: F401
        INTEGERTYPE as INTEGERTYPE,  # noqa: F401
        MATCHTYPE as MATCHTYPE,  # noqa: F401
        NULLTYPE as NULLTYPE,
        NUMERICTYPE as NUMERICTYPE,  # noqa: F401
        STRINGTYPE as STRINGTYPE,  # noqa: F401
        TABLEVALUE as TABLEVALUE,  # noqa: F401
        _resolve_value_to_type as _resolve_value_to_type,
    )
...
class TypeEngine(Visitable, Generic[_T]):
    ...
    @staticmethod
    def _to_instance(cls_or_self: type[_TE] | _TE) -> _TE:
    ...
    def _type_affinity(self) -> type[TypeEngine[_T]] | None:
...
class Emulated(TypeEngineMixin):
    ...
    def adapt_to_emulated(
        self,
        impltype: type[TypeEngine[Any] | TypeEngineMixin],
        **kw: Any,
    ) -> TypeEngine[Any]:
...
def _is_native_for_emulated(
    typ: type[TypeEngine[Any] | TypeEngineMixin],
...
class NativeForEmulated(TypeEngineMixin):
    ...
    def adapt_native_to_emulated(
        cls,
        impl: TypeEngine[Any] | TypeEngineMixin,
        **kw: Any,
    ) -> TypeEngine[Any]:
...
class TypeDecorator(SchemaEventTarget, ExternalType, TypeEngine[_T]):
    ...
    def _type_affinity(self) -> type[TypeEngine[Any]] | None:
    ...
    # mypy property bug
    @property
    def sort_key_function(self) -> Callable[[Any], Any] | None:  # type: ignore # noqa: E501
...
@overload
def to_instance(
    typeobj: type[_TE] | _TE, *arg: Any, **kw: Any
) -> _TE: ...
...
def to_instance(
    typeobj: type[_TE] | _TE | None, *arg: Any, **kw: Any
) -> _TE | TypeEngine[None]:
    if typeobj is None:
        return NULLTYPE
