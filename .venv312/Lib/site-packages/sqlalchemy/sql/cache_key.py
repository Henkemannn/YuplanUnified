...
_CacheKeyTraversalDispatchTypeReturn = Sequence[
    tuple[
        str,
        Any,
        Callable[..., tuple[Any, ...]] | CacheTraverseTarget | InternalTraversal,
    ]
]
...
class HasCacheKey:
    ...
    def _gen_cache_key(
        ...
        dispatcher: Literal[CacheConst.NO_CACHE] | _CacheKeyTraversalDispatchType
...
def _ad_hoc_cache_key_from_args(
    ...
    for (attrname, sym), arg in zip(traverse_args, args, strict=False):
        key = sym.name
