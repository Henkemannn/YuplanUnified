...
if TYPE_CHECKING:
    from ._typing import (
        ...
        _TypedColumnClauseArgument as _TCCA,
        _TypeEngineArgument,
    )
    ...
    from .elements import BinaryExpression, KeyedColumnElement, Label, NamedColumn, TextClause
...
_LabelConventionCallable = Callable[
    [Union["ColumnElement[Any]", "TextClause"]], str | None
]
...
class _OffsetLimitParam(BindParameter[int]):
    ...
    @property
    def _limit_offset_value(self) -> int | None:
...
class HasHints:
    ...
    def _with_hint(
        self,
        selectable: _FromClauseArgument | None,
        text: str,
        dialect_name: str,
    ) -> Self:
...
class FromClause(roles.AnonymizedFromClauseRole, Selectable):
    ...
    * Methods to generate various derivations of a "from" clause, including
    ...
    def join(
        ...
        onclause: _ColumnExpressionArgument[bool] | None = None,
        isouter: bool = False,
        full: bool = False,
    ) -> Join:
...
class Join(roles.DMLTableRole, FromClause):
    ...
    def _copy_internals(
        ...
        def replace(
            obj: BinaryExpression[Any] | ColumnClause[Any],
            **kw: Any,
        ) -> KeyedColumnElement[ColumnElement[Any]] | None:
    ...
    def _joincond_scan_left_right(
        cls,
        a: FromClause,
        a_subset: FromClause | None,
        b: FromClause,
        consider_as_foreign_keys: AbstractSet[ColumnClause[Any]] | None,
...
class AliasedReturnsRows(NoInit, NamedFromClause):
    ...
    def _init(self, selectable: Any, *, name: str | None = None) -> None:
...
class TableValuedAlias(LateralFromClause, Alias):
    ...
    def _init(
        ...
        *,
        name: str | None = None,
        table_value_type: TableValueType | None = None,
...
class CTE(
    ...
    def _init(
        ...
        *,
        ...
        recursive: bool = False,
        nesting: bool = False,
        _cte_alias: CTE | None = None,
        _restates: CTE | None = None,
        _prefixes: tuple[()] | None = None,
        _suffixes: tuple[()] | None = None,
    ) -> None:
...
class SelectsRows(ReturnsRows):
    ...
    def _generate_columns_plus_names(
        ...
        cols: _SelectIterable | None = None,
...
class Subquery(AliasedReturnsRows):
    ...
    @classmethod
    def _factory(
        cls, selectable: SelectBase, name: str | None = None
    ) -> Subquery:
...
class TableClause(roles.DMLTableRole, Immutable, NamedFromClause):
    ...
    @util.ro_memoized_property
    def _autoincrement_column(self) -> ColumnClause[Any] | None:
...
class ForUpdateArg(ClauseElement):
    ...
    def __init__(
        ...
        *,
        nowait: bool = False,
        read: bool = False,
        of: _ForUpdateOfArgument | None = None,
...
class SelectBase(
    ...
    def _generate_fromclause_column_proxies(
        ...
        subquery: FromClause,
        *,
        proxy_compound_columns: Iterable[Sequence[ColumnElement[Any]]] | None = None,
    ) -> None:
        raise NotImplementedError()
...
class GenerativeSelect(SelectBase, Generative):
    ...
    _limit_clause: ColumnElement[Any] | None = None
    _offset_clause: ColumnElement[Any] | None = None
    _fetch_clause: ColumnElement[Any] | None = None
    _fetch_clause_options: dict[str, bool] | None = None
    _for_update_arg: ForUpdateArg | None = None
    ...
    @overload
    def _offset_or_limit_clause_asint(
        self, clause: _OffsetLimitParam | None, attrname: str
    ) -> int | None: ...

    def _offset_or_limit_clause_asint(
        self, clause: ColumnElement[Any] | None, attrname: str
    ) -> NoReturn | int | None:
    ...
    def order_by(
        self,
        __first: Literal[None, _NoArg.NO_ARG] | _ColumnExpressionOrStrLabelArgument[Any] = _NoArg.NO_ARG,
...
class SelectState(util.MemoizedSlots, CompileState):
    ...
    def _column_naming_convention(
        ...
        def go(
            c: ColumnElement[Any] | TextClause,
    ...
    def _normalize_froms(
        ...
        check_statement: Select[Any] | None = None,
        ambiguous_table_name_map: _AmbiguousTableNameMap | None = None,
    ) -> list[FromClause]:
    ...
    def _get_display_froms(
        self,
        explicit_correlate_froms: Sequence[FromClause] | None = None,
        implicit_correlate_froms: Sequence[FromClause] | None = None,
    ) -> list[FromClause]:
    ...
    def _join_determine_implicit_left_side(
    ...
    ) -> tuple[FromClause | None, int | None]:
        ...
        replace_from_obj_index: int | None = None
...
class _MemoizedSelectEntities(
    ...
    _is_clone_of: ClauseElement | None
    _raw_columns: list[_ColumnsClauseElement]
...
class Select(
    ...
    _correlate_except: tuple[FromClause, ...] | None = None
    _where_criteria: tuple[ColumnElement[Any], ...] = ()
    ...
    def correlate(
        self,
        *fromclauses: Literal[None, False] | _FromClauseArgument,
    ) -> Self:
            ...
            prox = [
                ...
                for (
                    ...
                    zip(
                        ...
                        extra_col_iterator, strict=False,
                    )
                )
                if is_column_element(c)
            ]
    ...
    def self_group(
        self, against: OperatorType | None = None
    ) -> SelectStatementGrouping[Self] | Self:
...
class Exists(UnaryExpression[bool]):
    ...
    def __init__(
        self,
        __argument: _ColumnsClauseArgument[Any] | SelectBase | ScalarSelect[Any] | None = None,
    ):
        s: ScalarSelect[Any]
...
class TextualSelect(SelectBase, ExecutableReturnsRows, Generative):
        ...
        if proxy_compound_columns:
            fromclause._columns._populate_separate_keys(
                ...
                for c, extra_cols in zip(
                    self.column_args, proxy_compound_columns, strict=False
                )
            )
        else:
            fromclause._columns._populate_separate_keys(
    ...
    def _scalar_type(self) -> TypeEngine[Any] | Any:
