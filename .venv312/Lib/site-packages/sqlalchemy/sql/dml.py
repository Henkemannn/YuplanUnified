...
from . import coercions, roles, util as sql_util
...
from .elements import BooleanClauseList, ClauseElement, ColumnClause, ColumnElement, Null
...
if TYPE_CHECKING:
    from ._typing import (
        ...
        _DMLTableArgument,
        _TypedColumnClauseArgument as _TCCA,  # noqa
    )
...
class DMLState(CompileState):
    ...
    _multi_parameters: list[MutableMapping[_DMLColumnElement, Any]] | None = None
        ...
        for parameters in statement._multi_values:
            multi_parameters: list[MutableMapping[_DMLColumnElement, Any]] = [
                (
                    {
                        c.key: value
                        for c, value in zip(statement.table.c, parameter_set, strict=False)
                    }
...
class ValuesBase(UpdateBase):
    ...
    _multi_values: tuple[
        Sequence[dict[_DMLColumnElement, Any]] | Sequence[Sequence[Any]],
        ...,
    ] = ()
        ...
        **kwargs: Any,
        ...
        if args:
            ...
            if kwargs:
                ...
                # tuple values
                arg = {c.key: value for c, value in zip(self.table.c, arg, strict=False)}
