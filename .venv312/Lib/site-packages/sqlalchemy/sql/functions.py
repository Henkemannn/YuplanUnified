...
from .. import util
from . import annotation, coercions, operators, roles, schema, sqltypes, type_api, util as sqlutil
from ._typing import is_table_value_type
from .base import ColumnCollection, Executable, Generative, HasMemoized, _entity_namespace
...
def register_function(
    ...
    if identifier in reg:
        util.warn(
            f"The GenericFunction '{identifier}' is already registered and "
...
class FunctionElement(Executable, ColumnElement[_T], FromClause, Generative):
    ...
    _table_value_type: TableValueType | None = None
    ...
    def scalar_table_valued(
        self, name: str, type_: _TypeEngineArgument[_T] | None = None
    ...
    def column_valued(
        self, name: str | None = None, joins_implicitly: bool = False
...
class Function(FunctionElement[_T]):
    ...
    def __init__(
        ...
        *clauses: _ColumnExpressionOrLiteralArgument[Any],
        type_: _TypeEngineArgument[_T] | None = None,
        packagenames: tuple[str, ...] | None = None,
    ):
...
class count(GenericFunction[int]):
    ...
    def __init__(
        self,
        expression: _ColumnExpressionArgument[Any] | _StarOrOne | None = None,
        **kwargs: Any,
    ):
