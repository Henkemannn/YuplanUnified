...
from ... import Identity, Sequence, exc, schema as sa_schema, sql, text, util
from ...engine import cursor as _cursor, default, reflection
...
from ...sql import (
    ...
    roles,
    sqltypes,
    try_cast as try_cast,  # noqa: F401
    util as sql_util,
)
...
class MSDDLCompiler(compiler.DDLCompiler):
    ...
    def visit_drop_table_comment(self, drop, **kw):
        ...
        return (
            ...
            f"{self.preparer.quote_schema(schema_name)}, 'table', {self.preparer.format_table(drop.element, use_schema=False)}"
        )
    ...
    def get_isolation_level(self, dbapi_connection):
        ...
        try:
            cursor.execute(
                    ...
                    f"SELECT name FROM {view_name} WHERE name IN "
            ...
            raise NotImplementedError(
                f"Can't fetch isolation level;  encountered error {err} when "
                f'attempting to query the "{view_name}" view.'
            ) from err
        else:
            row = cursor.fetchone()
            return row[0].upper()
        ...
        for row in c.mappings():
            ...
            if is_identity is not None:
                ...
                if identity_start is None or identity_increment is None:
                    ...
                    if isinstance(coltype, sqltypes.BigInteger) or isinstance(coltype, sqltypes.Integer):
