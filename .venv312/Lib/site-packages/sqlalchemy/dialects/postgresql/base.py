...
from ...engine import URL, ObjectKind, ObjectScope, characteristics, default, interfaces, reflection
...
from . import arraylib as _array, json as _json, pg_catalog, ranges as _ranges
from .ext import _regconfig_fn, aggregate_order_by
from .hstore import HSTORE
from .named_types import (
    DOMAIN as DOMAIN,  # noqa: F401
    ENUM as ENUM,  # noqa: F401
    CreateDomainType as CreateDomainType,  # noqa: F401
    CreateEnumType as CreateEnumType,  # noqa: F401
    DropDomainType as DropDomainType,  # noqa: F401
    DropEnumType as DropEnumType,  # noqa: F401
    NamedType as NamedType,  # noqa: F401
)
from .types import (
    _DECIMAL_TYPES,  # noqa: F401
    _FLOAT_TYPES,  # noqa: F401
    _INT_TYPES,  # noqa: F401
    BIT as BIT,
    BYTEA as BYTEA,
    CIDR as CIDR,
    CITEXT as CITEXT,
    ...
    REGCONFIG as REGCONFIG,  # noqa: F401
    TIME as TIME,
    TIMESTAMP as TIMESTAMP,
    TSVECTOR as TSVECTOR,
    PGBit as PGBit,  # noqa: F401
    PGCidr as PGCidr,  # noqa: F401
    PGInet as PGInet,  # noqa: F401
    PGInterval as PGInterval,  # noqa: F401
    PGMacAddr as PGMacAddr,  # noqa: F401
    PGMacAddr8 as PGMacAddr8,  # noqa: F401
    PGUuid as PGUuid,
)
...
class PGDialect(default.DefaultDialect):
    ...
    def _split_multihost_from_url(self, url: URL) -> tuple[None, None] | tuple[tuple[str | None, ...], tuple[int | None, ...]]:
            ...
            if isinstance(url.query["host"], (list, tuple)):
                ...
                if (
                    ...
                    if host_port_match:
                        ...
                        hosts = (h,)
                        ports_str = cast(
                            "tuple[str | None, ...]", (p,) if p else (None,)
                        )
                    ...
                    if any(idx_elements_is_expr):
                        index["column_names"] = [
                            ...
                            for expr, is_expr in zip(
                                idx_elements, idx_elements_is_expr, strict=False
                            )
                        ]
        ...
        for domain in result.mappings():
            ...
            if domain["connames"]:
                ...
                sorted_constraints = sorted(
                    zip(domain["connames"], domain["condefs"], strict=False),
                    key=lambda t: t[0],
                )
