...
if True:  # zimports removes the tailing comments
    ...
    from typing_extensions import (
        ParamSpec as ParamSpec,  # 3.10
        Protocol as Protocol,  # 3.11
        SupportsIndex as SupportsIndex,  # 3.10
        TypeAliasType as TypeAliasType,  # 3.12
        TypedDict as TypedDict,  # 3.10
        dataclass_transform as dataclass_transform,  # 3.10
    )
...
_FN = TypeVar("_FN", bound=Callable[..., Any] | None)
