...
class safe_reraise:
    ...
    _exc_info: None | tuple[type[BaseException], BaseException, types.TracebackType] | tuple[None, None, None]
                ...
                kw_args.update(
                    [
                        ...
                        for arg, default in zip(
                            spec.args[-default_len:], spec.defaults, strict=False
                        )
                    ]
                )
    output: list[str] = []
...
def parse_user_argument_for_enum(
    ...
    for enum_value, choice in choices.items():
        if arg is enum_value or resolve_symbol_names and arg == enum_value.name or arg in choice:
            return enum_value
