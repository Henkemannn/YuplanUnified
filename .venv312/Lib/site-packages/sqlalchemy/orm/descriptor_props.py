...
from .. import event, exc as sa_exc, schema, sql, util
from ..sql import expression, operators
from ..sql.elements import BindParameter
from ..util.typing import is_fwd_ref, is_pep593, typing_get_args
from . import attributes, util as orm_util
from .base import LoaderCallableStatus, Mapped, PassiveFlag, SQLORMOperations, _DeclarativeMapped
...
class CompositeProperty(
    ...
    def __init__(
        self,
        _class_or_attr: None | type[_CC] | Callable[..., _CC] | _CompositeAttrType[Any] = None,
        ...
        def fset(instance: Any, value: Any) -> None:
            ...
            if value is None:
                ...
                for key, value in zip(
                    ...
                    self._composite_values_from_instance(value), strict=False,
                ):
            ...
            dest_dict.update(
                {
                    key: val
                    for key, val in zip(
                        attrs, get_values(dest_dict.pop(self.key)), strict=False
                    )
                }
            )
    ...
    class Comparator(PropComparator[_PT]):
        ...
        def _bulk_update_tuples(
            ...
            return list(zip(self._comparable_elements, values, strict=False))
        ...
        def _compare(
            ...
            comparisons = [
                operator(a, b)
                for a, b in zip(self.prop._comparable_elements, values, strict=False)
            ]
            if self._adapt_to_entity:
