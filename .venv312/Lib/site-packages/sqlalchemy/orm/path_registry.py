...
class PathRegistry(HasCacheKey):
    ...
    def __getitem__(
        self,
        entity: _StrPathToken | int | slice | _InternalEntityType[Any] | StrategizedProperty[Any],
    ) -> TokenRegistry | _PathElementType | _PathRepresentation | PropRegistry | AbstractEntityRegistry:
