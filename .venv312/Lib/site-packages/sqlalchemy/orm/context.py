...
from .. import exc as sa_exc, future, inspect, sql, util
from ..sql import coercions, expression, roles, util as sql_util, visitors
...
class QueryContext:
    ...
    def __init__(
        ...
        session: Session,
        load_options: type[QueryContext.default_load_options] | QueryContext.default_load_options,
        ...
        self.propagated_loader_options = tuple(
            ...
            for opt, uncached_opt in zip(cached_options, uncached_options, strict=False)
...
def _legacy_filter_by_entity_zero(
    query_or_augmented_select: Query[Any] | Select[Any]
...
class _BundleEntity(_QueryEntity):
    ...
    def row_processor(self, context, result):
        procs, labels, extra = zip(
            *[ent.row_processor(context, result) for ent in self._entities], strict=False
        )
