...
from .. import event, exc as sa_exc, inspection, log, schema, sql, util
...
from . import attributes, exc as orm_exc, instrumentation, loading, properties, util as orm_util
from ._typing import _O
from .base import PassiveFlag, _class_to_mapper, _parse_mapper_argument, _state_mapper, state_str
...
_WithPolymorphicArg = Union[
    Literal["*"],
    tuple[
        Literal["*"] | Sequence[Union["Mapper[Any]", type[Any]]],
        Optional["FromClause"],
    ],
...
class Mapper(
    ...
    def __init__(
        ...
        inherit_foreign_keys: Sequence[_ORMColumnExprArgument[Any]] | None = None,
        always_refresh: bool = False,
        version_id_col: _ORMColumnExprArgument[Any] | None = None,
        version_id_generator: Literal[False] | Callable[[Any], Any] | None = None,
        polymorphic_on: _ORMColumnExprArgument[Any] | str | MapperProperty[Any] | None = None,
    ...
    _validate_polymorphic_identity: Callable[[Mapper[_O], InstanceState[_O], _InstanceDict], None] | None
    ...
    def _make_prop_from_column(
        self,
        key: str,
        column: Sequence[KeyedColumnElement[Any]] | KeyedColumnElement[Any],
    ) -> ColumnProperty[Any]:
        ...
        if set(key_fns).difference([None]):
            ...
            def key(state):
                return tuple(
                    ...
                    for key_fn, val in zip(key_fns, state.key[1], strict=False)
                )
