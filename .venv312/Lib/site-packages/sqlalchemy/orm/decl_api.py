...
from ..util import hybridmethod, hybridproperty, typing as compat_typing
...
from .descriptor_props import Composite, Synonym, Synonym as _orm_synonym
...
_DeclaredAttrDecorated = Callable[
    ..., Mapped[_T] | ORMDescriptor[_T] | SQLCoreOperations[_T]
]
    ...
    def mapped_as_dataclass(
        ...
        *,
        ...
        def decorate(cls: type[_O]) -> type[_O]:
            cls._sa_apply_dc_transforms = {"init": init, "repr": repr, "eq": eq, "order": order, "unsafe_hash": unsafe_hash, "match_args": match_args, "kw_only": kw_only, "dataclass_callable": dataclass_callable}
