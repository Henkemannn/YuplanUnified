...
from ..sql import select, util as sql_util
from ..sql.selectable import LABEL_STYLE_TABLENAME_PLUS_COL, ForUpdateArg, SelectState
from ..util import EMPTY_DICT
from . import attributes, exc as orm_exc, path_registry
    ...
    *,
    ...
    if primary_key_identity is not None:
        ...
        if None in primary_key_identity:
            nones = {
                _get_params[col].key
                for col, value in zip(mapper.primary_key, primary_key_identity, strict=False)
                if value is None
            }
        ...
        params = {
            ...
            for id_val, primary_key in zip(
                primary_key_identity, mapper.primary_key, strict=False
            )
        }
    else:
        params = None
