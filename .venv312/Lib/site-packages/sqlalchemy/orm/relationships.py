...
from .. import Exists, exc as sa_exc, log, schema, sql, util
...
from ..util.typing import Literal, de_optionalize_union_types, resolve_name_to_real_class_name
...
_ORMOrderByArgument = Union[
    ...
    Iterable[str | _ColumnExpressionArgument[Any]],
]
            ...
            criterion = sql.and_(
                *[
                    ...
                    for (x, y) in zip(
                        ...
                        self.property.mapper.primary_key_from_instance(other), strict=False,
                    )
                ]
            )
