...
from .. import event, exc as sa_exc, inspect, log, sql, util
...
from .context import ORMCompileState, ORMSelectCompileState, QueryContext, _column_descriptions
        ...
        if splicing is False:
            ...
            if path[-2].isa(splicing):
                ...
                if detected_existing_path:
                    ...
                    if not detected_existing_path.contains_mapper(splicing) or path_registry.PathRegistry.coerce(
        ...
        if orig_query is context.query:
            ...
            new_options = [
                ...
                for orig_opt, uncached_opt in zip(
                    cached_options, uncached_options, strict=False
                )
            ]
