...
from .. import exc as sa_exc, inspect, inspection, log, sql, util
from ..engine import Result, Row
from ..event import EventTarget, dispatcher
from ..sql import Select, coercions, expression, roles, util as sql_util, visitors
from ..sql._typing import _TP, _FromClauseArgument
from ..sql.annotation import SupportsCloneAnnotations
from ..sql.base import Executable, Generative, _entity_namespace_key, _generative, _NoArg
...
from . import attributes, interfaces, loading, util as orm_util
...
class Query(
    ...
    _compile_options: type[CacheableOptions] | CacheableOptions = (
    ...
    _statement: ExecutableReturnsRows | None = None
    ...
    def __init__(
        self,
        entities: _ColumnsClauseArgument[Any] | Sequence[_ColumnsClauseArgument[Any]],
    ...
    def _set_entities(
        self,
        entities: _ColumnsClauseArgument[Any] | Iterable[_ColumnsClauseArgument[Any]],
    ) -> None:
        self._raw_columns = [
            coercions.expect(
    ...
    def _entity_from_pre_ent_zero(self) -> _InternalEntityType[Any] | None:
    ...
    def _get_options(
        ...
        only_load_props: Sequence[str] | None = None,
    ...
    def _statement_20(
        ...
        stmt: Select[_T] | FromStatement[_T]
    ...
    def with_parent(
        self,
        instance: object,
        property: attributes.QueryableAttribute[Any] | None = None,
        from_entity: _ExternalEntityType[Any] | None = None,
    ) -> Self:
    ...
    def add_entity(
        ...
        alias: Alias | Subquery | None = None,
    ) -> Query[Any]:
    ...
    @_generative
    def params(
        self, __params: dict[str, Any] | None = None, **kw: Any
    ) -> Self:
    ...
    def order_by(
        self,
        __first: Literal[None, False, _NoArg.NO_ARG] | _ColumnExpressionOrStrLabelArgument[Any] = _NoArg.NO_ARG,
    ...
    def _iter(self) -> ScalarResult[_T] | Result[_T]:
        # new style execution.
        params = self._params

        statement = self._statement_20()
        result: ScalarResult[_T] | Result[_T] = self.session.execute(
            statement,
            params,
    ...
    def merge_result(
        self,
        iterator: FrozenResult[Any] | Iterable[Sequence[Any]] | Iterable[object],
        load: bool = True,
    ) -> FrozenResult[Any] | Iterable[Any]:
    ...
    def update(
        ...
        update_args: dict[Any, Any] | None = None,
    ) -> int:
...
class AliasOption(interfaces.LoaderOption):
    ...
    def __init__(self, alias: Alias | Subquery):
...
class BulkUpdate(BulkUD):
    ...
    def __init__(
        ...
        query: Query[Any],
        values: dict[_DMLColumnArgument, Any],
        update_kwargs: dict[Any, Any] | None,
    ):
