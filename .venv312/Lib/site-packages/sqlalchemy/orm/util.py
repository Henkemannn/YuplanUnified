...
from .. import event, exc as sa_exc, inspection, sql, util
from ..engine.result import result_tuple
from ..sql import coercions, expression, lambdas, roles, util as sql_util, visitors
...
from ..util.typing import (
    Literal,
    Protocol,
    de_stringify_annotation as _de_stringify_annotation,
    de_stringify_union_elements as _de_stringify_union_elements,
    eval_name_only as _eval_name_only,
    is_origin_of_cls,
    typing_get_origin,
)
from . import (
...
from .base import (
    ...
    _never_set as _never_set,  # noqa: F401
    _none_set as _none_set,  # noqa: F401
    attribute_str as attribute_str,  # noqa: F401
    class_mapper as class_mapper,
    instance_str as instance_str,  # noqa: F401
    object_mapper as object_mapper,
    object_state as object_state,  # noqa: F401
    opt_manager_of_class,
    state_attribute_str as state_attribute_str,  # noqa: F401
    state_class_str as state_class_str,  # noqa: F401
    state_str as state_str,  # noqa: F401
)
...
class LoaderCriteriaOption(CriteriaOption):
    ...
    def __init__(
        ...
        where_criteria: _ColumnExpressionArgument[bool] | Callable[[Any], _ColumnExpressionArgument[bool]],
...
class _ORMJoin(expression.Join):
    ...
    def __init__(
        ...
        left_info = cast(
            "FromClause | _InternalEntityType[Any]",
    ...
    if is_dataclass_field:
        ...
        if not hasattr(annotated, "__origin__") or not is_origin_of_cls(
            ...
            if expect_mapped:
                ...
                if origin is typing.ClassVar or isinstance(origin, type) and issubclass(
