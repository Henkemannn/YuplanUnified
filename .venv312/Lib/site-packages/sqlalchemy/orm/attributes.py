...
from .base import (
    ...
    INCLUDE_PENDING_MUTATIONS,  # noqa
    INIT_OK,
    ...
    NO_RAISE,
    NO_VALUE,
    NON_PERSISTENT_OK,  # noqa
    PASSIVE_CLASS_MISMATCH,  # noqa
    PASSIVE_NO_FETCH,
    PASSIVE_NO_FETCH_RELATED,  # noqa
    PASSIVE_NO_INITIALIZE,
    PASSIVE_NO_RESULT,
    PASSIVE_OFF,
    PASSIVE_ONLY_PERSISTENT,
    PASSIVE_RETURN_NO_VALUE,
    RELATED_OBJECT_OK,  # noqa
    SQL_OK,  # noqa
    LoaderCallableStatus,
    Mapped as Mapped,  # noqa
    PassiveFlag,
    SQLORMExpression,
    _DeclarativeMapped,
    ...
    instance_str,
    manager_of_class as manager_of_class,
    opt_manager_of_class as opt_manager_of_class,
    state_str,
)
...
_AllPendingType = Sequence[
    tuple[Optional["InstanceState[Any]"], object | None]
]
...
class CollectionAttributeImpl(HasCollectionAdapter, AttributeImpl):
    ...
    def _invalidate_collection(
        ...
        adapter = collection._sa_adapter
