...
class InstrumentationEvents(event.Events[InstrumentationFactory]):
    ...
    def _accept_with(
        cls,
        target: InstrumentationFactory | type[InstrumentationFactory],
        identifier: str,
    ) -> InstrumentationFactory | type[InstrumentationFactory] | None:
    ...
    def _listen(
        ...
        def listen(target_cls: type, *arg: Any) -> Any | None:
            ...
            if propagate and issubclass(target_cls, listen_cls) or not propagate and target_cls is listen_cls:
...
class InstanceEvents(event.Events[ClassManager[Any]]):
    ...
    * the :class:`_orm.Mapper` class itself indicates listening for all
    ...
    def _accept_with(
        cls,
        target: ClassManager[Any] | type[ClassManager[Any]],
        identifier: str,
