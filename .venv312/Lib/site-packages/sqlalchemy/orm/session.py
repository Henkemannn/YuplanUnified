...
from .. import engine, exc as sa_exc, sql, util
...
from ._typing import _O, insp_is_mapper, is_composite_class, is_orm_option, is_user_defined_option
from .base import (
...
if typing.TYPE_CHECKING:
    ...
    from ._typing import OrmExecuteOptionsParameter, _EntityType, _IdentityKeyType, _InstanceDict
...
def _state_session(state: InstanceState[Any]) -> Session | None:
...
class ORMExecuteState(util.MemoizedSlots):
    ...
    _compile_state_cls: type[ORMCompileState] | None
    _starting_event_idx: int
    _events_todo: list[Any]
    _update_execution_options: _ExecuteOptions | None
    ...
    def __init__(
        ...
        execution_options: _ExecuteOptions,
        bind_arguments: _BindArguments,
        compile_state_cls: type[ORMCompileState] | None,
    ...
    def invoke_statement(
        self,
        statement: Executable | None = None,
        ...
        _params: _CoreAnyExecuteParams | None
        if params:
    ...
    def bind_mapper(self) -> Mapper[Any] | None:
        ...
        """
        mp: Mapper[Any] | None = self.bind_arguments.get("mapper", None)
        return mp
    ...
    def _orm_compile_options(
        self,
    ) -> context.ORMCompileState.default_compile_options | type[context.ORMCompileState.default_compile_options] | None:
    ...
    def load_options(
        self,
    ) -> context.QueryContext.default_load_options | type[context.QueryContext.default_load_options]:
        ...
        lo: context.QueryContext.default_load_options | type[context.QueryContext.default_load_options] = self.execution_options.get(
    ...
    def update_delete_options(
        self,
    ) -> bulk_persistence.BulkUDCompileState.default_update_options | type[bulk_persistence.BulkUDCompileState.default_update_options]:
        ...
        uo: bulk_persistence.BulkUDCompileState.default_update_options | type[bulk_persistence.BulkUDCompileState.default_update_options] = self.execution_options.get(
...
class SessionTransaction(_StateChange, TransactionalContext):
    ...
    _rollback_exception: BaseException | None = None

    _connections: dict[
        Engine | Connection, tuple[Connection, Transaction, bool, bool]
    ]
    session: Session
    _parent: SessionTransaction | None
    ...
    def __init__(
        ...
        session: Session,
        origin: SessionTransactionOrigin,
        parent: SessionTransaction | None = None,
    ):
    ...
    def connection(
        self,
        bindkey: Mapper[Any] | None,
        execution_options: _ExecuteOptions | None = None,
        **kwargs: Any,
    ) -> Connection:
    ...
    def _iterate_self_and_parents(
        self, upto: SessionTransaction | None = None
    ...
    def _connection_for_bind(
        self,
        bind: _SessionBind,
        execution_options: CoreExecuteOptionsParameter | None,
    ) -> Connection:
...
class Session(_SessionClassMethods, EventTarget):
    ...
    _transaction: SessionTransaction | None
    _nested_transaction: SessionTransaction | None
    hash_key: int
    autoflush: bool
    ...
    _trans_context_manager: TransactionalContext | None = None

    connection_callable: _ConnectionCallableProto | None = None
        ...
        *,
        ...
        if events_todo:
            ...
            for idx, fn in enumerate(events_todo):
                ...
                fn_result: Result[Any] | None = fn(orm_exec_state)
                if fn_result:
                    if _scalar_result:
    ...
    def _conditional_expire(
        self, state: InstanceState[Any], autoflush: bool | None = None
    ) -> None:
    ...
    def _get_impl(
        ...
        *,
        ...
        mapper: Mapper[_O] | None = inspect(entity)
    ...
    def _flush(self, objects: Sequence[object] | None = None) -> None:
