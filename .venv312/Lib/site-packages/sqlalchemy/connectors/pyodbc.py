...
from .. import ExecutionContext, pool, util
from ..engine import URL, ConnectArgsType, Connection, interfaces
...
class PyODBCConnector(Connector):
    ...
    def is_disconnect(
        self,
        e: Exception,
        connection: pool.PoolProxiedConnection | interfaces.DBAPIConnection | None,
