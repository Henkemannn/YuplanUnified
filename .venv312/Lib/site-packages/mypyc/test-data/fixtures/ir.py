...
class int:
    ...
    def __pow__(self, n: int, modulo: int | None = None) -> int: pass
...
class str:
    ...
    def split(self, sep: str | None = None, max: int | None = None) -> list[str]: pass
...
class list(Generic[_T], Sequence[_T], Iterable[_T]):
    def __init__(self, i: Iterable[_T] | None = None) -> None: pass
    @overload
...
class dict(Mapping[_K, _V]):
    ...
    @overload
    def __init__(self, iterable: Iterable[builtins.tuple[_K, _V]], **kwargs: _V) -> None: ...
...
class set(Generic[_T]):
    ...
    def __or__(self, s: set[_S] | frozenset[_S]) -> set[_T | _S]: ...
    def __xor__(self, s: set[_S] | frozenset[_S]) -> set[_T | _S]: ...

class frozenset(Generic[_T]):
    def __init__(self, i: Iterable[_T] | None = None) -> None: pass
    def __iter__(self) -> Iterator[_T]: pass
    def __len__(self) -> int: pass
    def __or__(self, s: builtins.set[_S] | frozenset[_S]) -> frozenset[_T | _S]: ...
    def __xor__(self, s: builtins.set[_S] | frozenset[_S]) -> frozenset[_T | _S]: ...
...
class Exception(BaseException):
    def __init__(self, message: str | None = None) -> None: pass
...
def enumerate(x: Iterable[_T]) -> Iterator[builtins.tuple[int, _T]]: ...
@overload
def zip(x: Iterable[_T], y: Iterable[_S]) -> Iterator[builtins.tuple[_T, _S]]: ...
@overload
def zip(x: Iterable[_T], y: Iterable[_S], z: Iterable[_V]) -> Iterator[builtins.tuple[_T, _S, _V]]: ...
def eval(e: str) -> Any: ...
