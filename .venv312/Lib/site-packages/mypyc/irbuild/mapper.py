...
class Mapper:
    ...
    def type_to_rtype(self, typ: Type | None) -> RType:
        ...
        elif isinstance(typ, AnyType) or isinstance(typ, TypeType):
            return object_rprimitive
    ...
    def fdef_to_sig(self, fdef: FuncDef) -> FuncSignature:
        if isinstance(fdef.type, CallableType):
            arg_types = [
                ...
                for typ, kind in zip(fdef.type.arg_types, fdef.type.arg_kinds, strict=False)
            ]
        ...
        args = [
            ...
            for arg_name, arg_kind, arg_type, arg_pos_only in zip(
                arg_names, fdef.arg_kinds, arg_types, arg_pos_onlys, strict=False
            )
        ]
