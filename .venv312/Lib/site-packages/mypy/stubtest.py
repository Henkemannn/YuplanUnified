...
from typing import AbstractSet, Any, Generic, TypeVar, Union, get_origin, is_typeddict
...
def _verify_signature(
    ...
    for stub_arg, runtime_arg in zip(stub.pos, runtime.pos, strict=False):
    ...
    if isinstance(
        ...
        if signature:
            ...
            for arg in signature.parameters.values():
                ...
                if arg.kind == inspect.Parameter.POSITIONAL_ONLY or arg.kind == inspect.Parameter.POSITIONAL_OR_KEYWORD:
