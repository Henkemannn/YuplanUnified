...
from typing import Any, Final, Literal, TypeVar, Union, cast, overload
...
class ASTConverter:
    ...
    def do_func_def(
        ...
        for arg, arg_type in zip(args, arg_types, strict=False):
    ...
    def transform_args(
        ...
        for i, (a, d) in enumerate(zip(args_args[num_no_defaults:], args_defaults, strict=False)):
        ...
        for a, kd in zip(args.kwonlyargs, args.kw_defaults, strict=False):
            new_args.append(
                self.make_argument(
    ...
    def visit_Dict(self, n: ast3.Dict) -> DictExpr:
        e = DictExpr(
            list(zip(self.translate_opt_expr_list(n.keys), self.translate_expr_list(n.values), strict=False))
        )
        return self.set_line(e, n)
