...
def type_object_type_from_function(
    ...
    if isinstance(signature, CallableType):
        ...
        for item, orig_self in zip(signature.items, orig_self_types, strict=False):
...
def bind_self(
    ...
    if func.variables and supported_self_type(
        ...
        func = expand_type(func, {tv.id: arg for tv, arg in zip(self_vars, to_apply, strict=False)})
    ...
    for _direction in range(2):
        ...
        for ti in items:
            ...
            if duplicate_index != -1:
                ...
                if not orig_item.can_be_true and ti.can_be_true or not orig_item.can_be_false and ti.can_be_false:
