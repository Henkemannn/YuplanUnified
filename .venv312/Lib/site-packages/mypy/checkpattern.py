...
class PatternChecker(PatternVisitor[PatternType]):
    ...
    def visit_sequence_pattern(self, o: SequencePattern) -> PatternType:
        ...
        for p, t in zip(o.patterns, contracted_inner_types, strict=False):
        ...
        if isinstance(current_type, TupleType) and unpack_index is None:
            ...
            inner_rest_types = []
            for inner_type, new_inner_type in zip(inner_types, new_inner_types, strict=False):
    ...
    def visit_mapping_pattern(self, o: MappingPattern) -> PatternType:
        ...
        can_match = True
        captures: dict[Expression, Type] = {}
        for key, value in zip(o.keys, o.values, strict=False):
    ...
    def visit_class_pattern(self, o: ClassPattern) -> PatternType:
        ...
        if len(o.positionals) != 0:
            if self.should_self_match(typ):
                ...
                for arg_name, pos in zip(match_arg_names, o.positionals, strict=False):
        ...
        for key, value in zip(o.keyword_keys, o.keyword_values, strict=False):
