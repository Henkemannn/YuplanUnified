...
def add_column(
    table_name: str, column: Column[Any], *, schema: str | None = None
) -> None:
...
def batch_alter_table(
    ...
    partial_reordering: tuple[Any, ...] | None = None,
...
def drop_table(
    table_name: str, *, schema: str | None = None, **kw: Any
) -> None:
...
def inline_literal(
    value: str | int, type_: TypeEngine[Any] | None = None
) -> _literal_bindparam:
...
@overload
def invoke(
    operation: AddConstraintOp | DropConstraintOp | CreateIndexOp | DropIndexOp | AddColumnOp | AlterColumnOp | AlterTableOp | CreateTableCommentOp | DropTableCommentOp | DropColumnOp | BulkInsertOp | DropTableOp | ExecuteSQLOp
) -> None: ...
@overload
...
def register_operation(
    name: str, sourcename: str | None = None
...
def rename_table(
    old_table_name: str, new_table_name: str, *, schema: str | None = None
) -> None:
