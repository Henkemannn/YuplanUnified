...
from sqlalchemy import Integer, exc, types as sqltypes
from sqlalchemy.ext.compiler import compiles
from sqlalchemy.schema import Column, DDLElement
from sqlalchemy.sql.elements import quoted_name

from ..util.sqla_compat import (
    _columns_for_constraint,  # noqa
    _find_columns,  # noqa
    _fk_spec,  # noqa
    _is_type_bound,  # noqa
    _table_for_constraint,  # noqa
)
...
class DropColumn(AlterTable):
    def __init__(
        self, name: str, column: Column[Any], schema: str | None = None
    ) -> None:
        super().__init__(name, schema=schema)
        self.column = column
