...
from ..util.sqla_compat import _is_mariadb, _is_type_bound, compiles
from .base import (
    AlterColumn,
    ColumnDefault,
    ColumnName,
...
class MySQLImpl(DefaultImpl):
    ...
    def alter_column(  # type:ignore[override]
        ...
        server_default: _ServerDefault | Literal[False] = False,
        name: str | None = None,
        type_: TypeEngine | None = None,
        schema: str | None = None,
        existing_type: TypeEngine | None = None,
        existing_server_default: _ServerDefault | None = None,
    ...
    def _is_mysql_allowed_functional_default(
        ...
        server_default: _ServerDefault | Literal[False],
    ) -> bool:
        return (
            type_ is not None
    ...
    def compare_server_default(
        ...
        if (
            ...
            if onupdate_ins:
                if not onupdate_met or onupdate_ins.group(2) != onupdate_met.group(2):
                    return True
...
class MySQLChangeColumn(AlterColumn):
    def __init__(
        ...
        type_: TypeEngine | None = None,
        nullable: bool | None = None,
        default: _ServerDefault | Literal[False] | None = False,
        autoincrement: bool | None = None,
        comment: str | Literal[False] | None = False,
    ) -> None:
        super(AlterColumn, self).__init__(name, schema=schema)
...
def _mysql_colspec(
    ...
    nullable: bool | None,
    server_default: _ServerDefault | Literal[False] | None,
    type_: TypeEngine,
