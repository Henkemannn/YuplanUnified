...
from sqlalchemy import Column, Numeric, literal_column, text, types as sqltypes
...
class PostgresqlImpl(DefaultImpl):
    ...
    def compare_indexes(
        ...
        skip = []
        for pos, (m_e, r_e) in enumerate(zip(m_exprs, r_exprs, strict=False), 1):
...
class CreateExcludeConstraintOp(ops.AddConstraintOp):
    ...
    def __init__(
        ...
        elements: Sequence[tuple[str, str]] | Sequence[tuple[ColumnClause[Any], str]],
