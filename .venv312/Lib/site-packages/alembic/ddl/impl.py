...
from sqlalchemy import cast, schema, text

from .. import util
from ..util import sqla_compat
from . import _autogen, base
from ._autogen import ComparisonResult as ComparisonResult, _constraint_sig as _constraint_sig
    ...
    def alter_column(
        ...
        **kw: Any,
        ...
        if server_default is not False:
            kw = {}
            cls_: type[
                base.ComputedColumnDefault | base.IdentityColumnDefault | base.ColumnDefault
            ]
