...
def configure(
    ...
    include_name: Callable[[str | None, Literal["schema", "table", "column", "index", "unique_constraint", "foreign_key_constraint"], MutableMapping[Literal["schema_name", "table_name", "schema_qualified_table_name"], str | None]], bool] | None = None,
    include_object: Callable[[SchemaItem, str | None, Literal["schema", "table", "column", "index", "unique_constraint", "foreign_key_constraint"], bool, SchemaItem | None], bool] | None = None,
    include_schemas: bool = False,
    process_revision_directives: Callable[[MigrationContext, str | Iterable[str | None] | Iterable[str], list[MigrationScript]], None] | None = None,
    compare_type: bool | Callable[[MigrationContext, Column[Any], Column[Any], TypeEngine[Any], TypeEngine[Any]], bool | None] = True,
    compare_server_default: bool | Callable[[MigrationContext, Column[Any], Column[Any], str | None, FetchedValue | None, str | None], bool | None] = False,
    render_item: Callable[[str, Any, AutogenContext], str | Literal[False]] | None = None,
    ...
    on_version_apply: Callable[[MigrationContext, MigrationInfo, Collection[Any], Mapping[str, Any]], None] | None = None,
    **kw: Any,
) -> None:
