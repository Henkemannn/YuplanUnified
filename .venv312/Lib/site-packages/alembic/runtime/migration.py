...
from sqlalchemy import Column, MetaData, PrimaryKeyConstraint, String, Table, literal_column
from sqlalchemy.engine import Engine, url as sqla_url
...
class MigrationContext:
    ...
    def __init__(
        ...
        self._migrations_fn: Callable[..., Iterable[RevisionStep]] | None = opts.get("fn")
        self.as_sql = as_sql
        ...
        self.version_table_schema = version_table_schema = opts.get("version_table_schema")
        self._version = Table(
            version_table,
            MetaData(),
    ...
    ) -> _ProxyTransaction | ContextManager[None]:
    ...
    def _compare_server_default(
        ...
        rendered_column_default: str | None,
    ) -> bool:
