...
from sqlalchemy import __version__, inspect, schema, sql, types as sqltypes
...
if TYPE_CHECKING:
    from sqlalchemy import ClauseElement, Index, Table
...
def _insert_inline(table: TableClause | Table) -> Insert:
    if sqla_14:
...
if sqla_14:
    ...
    from sqlalchemy import create_mock_engine, select as _sa_select
