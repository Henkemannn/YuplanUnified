...
try:
    if compat.py39:
        ...
        from backports.zoneinfo import (
            ZoneInfo,  # type: ignore[import-not-found,no-redef] # noqa: E501
            ZoneInfoNotFoundError,  # type: ignore[no-redef] # noqa: E501
        )
except ImportError:
...
class ScriptDirectory:
    ...
    def from_config(cls, config: Config) -> ScriptDirectory:
        ...
        version_locations: list[str] | None
        if version_locations_str:
            ...
            try:
                split_char: str | None = split_on_path[
                    version_path_separator
                ]
