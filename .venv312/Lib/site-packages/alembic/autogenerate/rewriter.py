...
class Rewriter:
    ...
    _chained: tuple[ProcessRevisionDirectiveFn | Rewriter, ...] = ()
    ...
    def chain(
        self,
        other: ProcessRevisionDirectiveFn | Rewriter,
    ) -> Rewriter:
    ...
    def rewrites(
        self,
        operator: type[AddColumnOp] | type[MigrateOperation] | type[AlterColumnOp] | type[CreateTableOp] | type[ModifyTableOps],
    ) -> Callable[..., Any]:
