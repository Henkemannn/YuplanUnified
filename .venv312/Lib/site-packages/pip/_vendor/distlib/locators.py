...
class SimpleScrapingLocator(Locator):
    ...
    def _should_queue(self, link, referrer, rel):
        ...
        if path.endswith(self.source_extensions + self.binary_extensions + self.excluded_extensions) or self.skip_externals and not link.startswith(self.base_url) or not referrer.startswith(self.base_url) or rel not in ("homepage", "download") or scheme not in ("http", "https", "ftp") or self._is_platform_dependent(link):
            result = False
        else:
