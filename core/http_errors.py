...
def forbidden(
    detail: str, problem_type: str = "https://example.com/problems/forbidden", **extra: object
) -> Response:
...
def _std(
    status: int, slug: str, title: str, detail: str | None = None, **extra: object
) -> Response:
...
def unauthorized(
    detail: str = "unauthorized", www_auth: str | None = None, **extra: object
) -> Response:
...
def unprocessable_entity(
    errors: object | list[dict[str, object]], detail: str = "validation_error", **extra: object
) -> Response:
    return _std(422, "validation_error", "Unprocessable Entity", detail, errors=errors, **extra)


def too_many_requests(
    detail: str = "rate_limited", retry_after: int | None = None, **extra: object
) -> Response:
...
def internal_server_error(
    detail: str = "internal_error", incident_id: str | None = None, **extra: object
) -> Response:
    if not incident_id:
        incident_id = str(uuid.uuid4())
    return _std(
        500, "internal_error", "Internal Server Error", detail, incident_id=incident_id, **extra
    )
