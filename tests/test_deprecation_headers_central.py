...
def test_notes_alias_has_deprecation_headers(client):
    ...
    assert any(n == "deprecation.alias.emitted" and c.get("endpoint") == "notes" for n, c in rec.calls)
...
def test_tasks_alias_has_deprecation_headers(client):
    ...
    assert any(n == "deprecation.alias.emitted" and c.get("endpoint") == "tasks" for n, c in rec.calls)
